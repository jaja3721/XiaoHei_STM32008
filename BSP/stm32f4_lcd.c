...
//  if(lcdid == 0x9320)
  ...
  /* Start Initial Sequence ------------------------------------------------*/
   ...
   LCD_WriteReg(0x00D0);
   LCD_WriteRAM(0x0007);//0x07
   LCD_WriteRAM(0x0042);//0x42
   LCD_WriteRAM(0x0015);//0x1d

   LCD_WriteReg(0x00D1);
   LCD_WriteRAM(0x0000);
   LCD_WriteRAM(0x001a);
   LCD_WriteRAM(0x0009);// 09  VCOMH
...
void LCD_SetCursor(uint16_t x, uint16_t y)
{
	LCD_WriteReg(0x002A);
	LCD_WriteRAM(x>>8);
	LCD_WriteRAM(0x00FF&x);


	LCD_WriteReg(0x002B);
	LCD_WriteRAM(y>>8);
	LCD_WriteRAM(0x00FF&y);
}
...
void LCD_DisplayStringLine(uint16_t Line, uint8_t *ptr)
{
  ...
  {
    /* Display one character on LCD */
    LCD_DisplayChar(LCD_PIXEL_WIDTH-refcolumn,Line,  *ptr);
    /* Decrement the column position by 16 */
    refcolumn -= LCD_Currentfonts->Width;
...
/**
  ...
  * @retval None
  */
void LCD_WriteReg(uint16_t LCD_Reg)
{
  /* Write 16-bit Index, then Write Reg */
 // LCD->LCD_REG = LCD_Reg;
  /* Write 16-bit Reg */
 // LCD->LCD_RAM = LCD_RegValue;
	*(volatile u16 *) (((u32)0x68000000))= LCD_Reg;
}
...
void LCD_WriteRAM(uint16_t RGB_Code)
{
  ...
  //LCD->LCD_RAM = RGB_Code;
	...
	*(volatile u16 *) (((u32)0x68000002))= RGB_Code; 
}
...
void LCD_CtrlLinesConfig(void)
{
  ...
  /* Enable GPIOs clock */
  RCC_AHB1PeriphClockCmd(RCC_AHB1Periph_GPIOD | RCC_AHB1Periph_GPIOE | RCC_AHB1Periph_GPIOF | RCC_AHB1Periph_GPIOB | RCC_AHB1Periph_GPIOG, ENABLE);
